...
from app_dir.api.utils import IsPermittedCreateView, IsAdminOrPermitted, generate_token
...
def register_payments(request):
    ...
    request_to_send = {
        ...
        "ConfirmationURL": "http://alexkiburu.pythonanywhere.com/confirmation/",
        "ValidationURL": "http://alexkiburu.pythonanywhere.com/validation/"
        }
